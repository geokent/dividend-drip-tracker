    ...
    <Card className="p-5 mb-6 bg-gradient-to-r from-primary/5 to-accent/5 border-primary/10">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <div className="text-center">
          ...
          <p className="text-lg font-semibold text-primary mt-1">{formatCurrency(totalMonthlyDividends)}</p>
        </div>
        <div className="text-center">
          <p className="text-xs text-muted-foreground uppercase tracking-wide font-medium">Annual Dividends</p>
          <p className="text-lg font-semibold text-primary mt-1">{formatCurrency(totalAnnualDividends)}</p>
        </div>
      </div>
    </Card>
  );
